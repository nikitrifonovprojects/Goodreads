        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditionLanguage = table.Column<string>(nullable: true),
                    LiteraryAwards = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: false),
                    Born = table.Column<string>(nullable: false),
                    ...
                    AuthorData = table.Column<string>(nullable: true),
                    BookId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Genres_Authors_AuthorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PictureFile = table.Column<byte[]>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pictures_Characters_CharacterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Genres_AuthorsId",
                table: "Genres",
                column: "AuthorsId");

            migrationBuilder.CreateIndex(
                name: "IX_Pictures_CharacterId",
                table: "Pictures",
                column: "CharacterId");
        }
